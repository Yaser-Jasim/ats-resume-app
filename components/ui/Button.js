export default function Button({ variant = 'primary', className = '', children, ...props }) {
  ...
  const variants = {
      primary: 'text-white bg-gradient-to-b from-orange-400 to-orange-600 ' +
      'shadow-[inset_0_1px_0_rgba(255,255,255,0.25),inset_0_-2px_0_rgba(0,0,0,0.15),0_6px_14px_-4px_rgba(234,88,12,0.5)] ' +
      'hover:from-orange-500 hover:to-orange-700 ' +
      'active:translate-y-px active:shadow-[inset_0_1px_0_rgba(255,255,255,0.15),inset_0_-1px_0_rgba(0,0,0,0.15),0_2px_6px_-2px_rgba(234,88,12,0.5)]',
